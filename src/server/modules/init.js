...
const {load_config} = await import(window.base_url+"utils/project.js") 
...
function make_cesium_container() {
    ...
    document.body.appendChild(cesium_div)
}


async function main(){
    await load_config() //esperamos a que la configuracion cargue
